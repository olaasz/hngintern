    ...
    <div id="page-content-scroll"><!--Enables this element to be scrolled -->
        ...
        <div class="content-strip">
            <div class="strip-content">
                <h4>HNG INTERN</h4>
                <p>PHP contact form with MySQL and Form Validation with Timestamp.</p>
        ...
        <div class="content">
            ...
            <div class="page-blog" style="margin:auto !important;">
                <!-- POST 1-->
                <div class="page-blog-list">
                    ...
                    <div class="page-blog-content">
                        ...
                        <div class="blog-post-comments full-bottom">
                            ...
                            <div class="center blog-post-comment-add">
                              ...
                              <form action="insert.php" method="post">
                                ...
                                <em>required</em>
                                <input type="hidden" name="time" value="<?php $time = date("F j, Y, g:i a"); echo $time; ?>">
                                <textarea name="message" required cols="30" rows="3"></textarea>
                                <input style="margin:auto;" type="submit" value="Submit Message" class="button button-green button-right full-top full-bottom">
...
<div class="share-bottom share-light">
    ...
    <div class="share-socials-bottom">
        <a href="https://www.facebook.com/emolayiwola">
            <i class="fa fa-facebook facebook-color"></i>
            Facebook
        </a>
        <a href="https://twitter.com/emolayiwola">
